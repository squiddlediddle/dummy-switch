     ...
     "blocks": [
      {
       ...
       "everyone": {
        "kind": "paragraph",
        "text": "Take the cycle seriously and the manifest world is not a stage where material objects perform — it is a *process of information*. Photons are couriers; the visual field is the translation of their deliveries. There are exactly two layers and no third substance: the structural layer (the physics legs — light emitted, scattered, absorbed, whatever the cycle's equations describe) and the manifest layer (the decoded output we actually meet). The identifying move is that manifest reality *is* that decoded output. That threads the needle between physicalism and idealism: the world is genuinely real (not mind-made) yet essentially informational (not dumb stuff).",
        "level": null,
        "number": null,
        "name": "Take the cycle seriously and the manifest world is not a stage where material objects perform — it is a *process of information*. Photons are couriers; the visual field is the translation of their deliveries. There are exactly two layers and no third substance: the structural layer (the physics legs — light emitted, scattered, absorbed, whatever the cycle's equations describe) and the manifest layer (the decoded output we actually meet). The identifying move is that manifest reality *is* that decoded output. That threads the needle between physicalism and idealism: the world is genuinely real (not mind-made) yet essentially informational (not dumb stuff)."
       }
      }
     ]
    },
     ...
     "blocks": [
      {
       ...
       "everyone": {
        "kind": "paragraph",
        "text": "Light is the past arriving at you. Every photon that lands is a message shipped from the moment it was emitted; look at Andromeda and you are handling mail that left billions of years ago. So the past is not a wistful illusion — parts of it are still in transit and arrive every second. That dissolves a would-be war between two camps: eternalism (the geometry of spacetime says the past is still there — the light cone exists) and presentism (we only ever seem to meet the now). Both are right: the cone is there, and the frontier of it that is *legible to you* moves as you move. The past is real; the present is the slice of it that has reached you.",
        "level": null,
        "number": null,
        "name": "Light is the past arriving at you. Every photon that lands is a message shipped from the moment it was emitted; look at Andromeda and you are handling mail that left billions of years ago. So the past is not a wistful illusion — parts of it are still in transit and arrive every second. That dissolves a would-be war between two camps: eternalism (the geometry of spacetime says the past is still there — the light cone exists) and presentism (we only ever seem to meet the now). Both are right: the cone is there, and the frontier of it that is *legible to you* moves as you move. The past is real; the present is the slice of it that has reached you."
       }
      }
     ]
    },
     ...
     "blocks": [
      {
       ...
       "everyone": {
        "kind": "paragraph",
        "text": "Wheeler supplied the slogan — \"it from bit,\" everything is built from answers to yes-or-no questions. The cycle supplies the blueprint: the bits actually arrive, as photons. A bit here is not an abstraction; it is a physical event — a photon's energy, timing, direction — and every \"it\" you see is a decoded pile of such arrivals. Wheeler said the universe runs on information; the cycle says which channel (light), which code (the photonic stream), and where the decoding happens (the cycle's stages).",
        "level": null,
        "number": null,
        "name": "Wheeler supplied the slogan — \"it from bit,\" everything is built from answers to yes-or-no questions. The cycle supplies the blueprint: the bits actually arrive, as photons. A bit here is not an abstraction; it is a physical event — a photon's energy, timing, direction — and every \"it\" you see is a decoded pile of such arrivals. Wheeler said the universe runs on information; the cycle says which channel (light), which code (the photonic stream), and where the decoding happens (the cycle's stages)."
       }
      }
     ]
    },
   ...
   "blocks": [
    {
     ...
     "everyone": {
      "kind": "paragraph",
      "text": "The whole theory in three clauses: knowledge arrives by courier — every fact you hold about the world came through the light; the manifest world *is* the courier's deliveries, decoded; and the flow of time you feel is the tempo at which those deliveries arrive and are turned into experience. Messenger, message, tempo.",
      "level": null,
      "number": null,
      "name": "The whole theory in three clauses: knowledge arrives by courier — every fact you hold about the world came through the light; the manifest world *is* the courier's deliveries, decoded; and the flow of time you feel is the tempo at which those deliveries arrive and are turned into experience. Messenger, message, tempo."
     }
    },
    {
     "original": {
