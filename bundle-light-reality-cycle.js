   ...
   "subsections": [
    {
     ...
     "blocks": [
      ...
      },
      {
       ...
       "everyone": {
        "kind": "paragraph",
        "text": "That one-line idea is the whole project. This paper takes it seriously: it writes the idea out carefully enough that you can argue with it, and then defends a strong version of it. Not as physics — as a theory of what reality is.",
        "level": null,
        "number": null,
        "name": "That one-line idea is the whole project. This paper takes it seriously: it writes the idea out carefully enough that you can argue with it, and then defends a strong version of it. Not as physics — as a theory of what reality is."
       }
      }
     ]
    },
   ...
   "blocks": [
    {
     ...
     "everyone": {
      "kind": "paragraph",
      "text": "A theory about the nature of reality can't be proved the way you prove a maths theorem, or tested the way you test a law of physics. But it can be argued — carefully. This section is the careful part. It comes in five moves:",
      "level": null,
      "number": null,
      "name": "A theory about the nature of reality can't be proved the way you prove a maths theorem, or tested the way you test a law of physics. But it can be argued — carefully. This section is the careful part. It comes in five moves:"
     }
    },
    {
     "original": {
     ...
     "blocks": [
      {
       ...
       "everyone": {
        "kind": "paragraph",
        "text": "Claim (1) says we see the world by light. There isn't a lot to argue about here: the biology of the eye and the physics of light both back it up.",
        "level": null,
        "number": null,
        "name": "Claim (1) says we see the world by light. There isn't a lot to argue about here: the biology of the eye and the physics of light both back it up."
       }
      },
      {
       "original": {
       ...
       "everyone": {
        "kind": "list",
        "text": "- **Vision is the main sense.** Sight does most of the work, and about a third of the cortex — the brain's outer layer, where the heavy lifting happens — is given over to handling it.\n- The visual realism we enjoy is *exactly* the physical content of electromagnetic information: shape from shading, color from spectral composition, motion from successive photon arrival patterns.\n- Every stage of the cycle is well-mapped: light-triggering in the retina, encoding in nerve cells, decoding in cortex (Hubel & Wiesel's maps; modern predictive-coding accounts).\n- Even the famous seams of vision support the account: blindsight subjects process photonic information unconsciously; the blind spot and saccadic suppression show the cycle is *lossy* — perception is reconstruction under constraint, which is exactly what an information channel predicts.",
        "level": null,
        "number": null,
        "name": "- **Vision is the main sense.** Sight does most of the work, and about a third of the cortex — the brain's outer layer, where the heavy lifting happens — is given over to handling it.\n- The visual realism we enjoy is *exactly* the physical content of electromagnetic information: shape from shading, color from spectral composition, motion from successive photon arrival patterns.\n- Every stage of the cycle is well-mapped: light-triggering in the retina, encoding in nerve cells, decoding in cortex (Hubel & Wiesel's maps; modern predictive-coding accounts).\n- Even the famous seams of vision support the account: blindsight subjects process photonic information unconsciously; the blind spot and saccadic suppression show the cycle is *lossy* — perception is reconstruction under constraint, which is exactly what an information channel predicts."
       }
      }
     ]
    },
     ...
     "blocks": [
      {
       ...
       "everyone": {
        "kind": "paragraph",
        "text": "Claim (2) goes a lot further: it says reality itself *is* the information that light delivers. No experiment settles that, so it's a philosophical claim. Here's how it's argued:",
        "level": null,
        "number": null,
        "name": "Claim (2) goes a lot further: it says reality itself *is* the information that light delivers. No experiment settles that, so it's a philosophical claim. Here's how it's argued:"
       }
      },
      {
       "original": {
     ...
     "blocks": [
      {
       ...
       "everyone": {
        "kind": "paragraph",
        "text": "There is no universal \"now\" — relativity saw to that. So why does this moment still feel like something special? The cycle's answer:",
        "level": null,
        "number": null,
        "name": "There is no universal \"now\" — relativity saw to that. So why does this moment still feel like something special? The cycle's answer:"
       }
      },
      {
       "original": {
       ...
       "everyone": {
        "kind": "list",
        "text": "- **Light arrives in order.** Things are seen in the order their light reaches you, but the brain gathers those arrivals up over a short window — a fraction of a second for \"at the same time\", a couple of seconds for the \"now\" you can actually feel. So the theory never tries to match what you feel to some universal clock. It only has to match your sense of order to the order the light arrived in.\n- The felt \"now\" is the leading edge of the integrated window: retention, primal impression, protention (Husserl). The theory supplies the physical bookkeeping underneath: the window is a moving integration over a photon-spike stream.",
        "level": null,
        "number": null,
        "name": "- **Light arrives in order.** Things are seen in the order their light reaches you, but the brain gathers those arrivals up over a short window — a fraction of a second for \"at the same time\", a couple of seconds for the \"now\" you can actually feel. So the theory never tries to match what you feel to some universal clock. It only has to match your sense of order to the order the light arrived in.\n- The felt \"now\" is the leading edge of the integrated window: retention, primal impression, protention (Husserl). The theory supplies the physical bookkeeping underneath: the window is a moving integration over a photon-spike stream."
       }
      }
     ]
    },
     ...
     "blocks": [
      {
       ...
       "everyone": {
        "kind": "paragraph",
        "text": "The theory's best-known line — \"the photon's journey is time\" — sounds like poetry. Here's what it actually means when you spell it out:",
        "level": null,
        "number": null,
        "name": "The theory's best-known line — \"the photon's journey is time\" — sounds like poetry. Here's what it actually means when you spell it out:"
       }
      },
      {
       "original": {
       ...
       "everyone": {
        "kind": "list",
        "text": "- **Light sets the order.** You see things in the order their light gets to you: whatever left first arrives first. Look at anything at all and you are looking at it as it was when the light left it.\n- Perceptual integration: the system samples this ordered stream at its encoding rate and integrates over the specious window.\n- Felt rate hypothesis (A5): felt time per real second is a function of information throughput.\n- Everyday illustration: a lightning flash and its thunder — the light arrives nearly instantly; the pressure wave lags ~3 s per km of distance. We perceive the flash \"now\" and the thunder \"now plus delay\"; both are the same event. The *ordering* is physically enforced by carrier speed — and our sense of a temporal gap between flash and thunder is precisely an information-arrival gap, not a physical separation of the event from itself. The cycle reads the same story twice, at two carrier speeds.\n- Astronomical illustration: the Sun is seen as it was 8.3 minutes ago; Andromeda as it was 2.5 million years ago. Star maps are not images of a single \"now\" — they are a montage of *delivered pasts*. The night sky is the cycle's canonical artifact.",
        "level": null,
        "number": null,
        "name": "- **Light sets the order.** You see things in the order their light gets to you: whatever left first arrives first. Look at anything at all and you are looking at it as it was when the light left it.\n- Perceptual integration: the system samples this ordered stream at its encoding rate and integrates over the specious window.\n- Felt rate hypothesis (A5): felt time per real second is a function of information throughput.\n- Everyday illustration: a lightning flash and its thunder — the light arrives nearly instantly; the pressure wave lags ~3 s per km of distance. We perceive the flash \"now\" and the thunder \"now plus delay\"; both are the same event. The *ordering* is physically enforced by carrier speed — and our sense of a temporal gap between flash and thunder is precisely an information-arrival gap, not a physical separation of the event from itself. The cycle reads the same story twice, at two carrier speeds.\n- Astronomical illustration: the Sun is seen as it was 8.3 minutes ago; Andromeda as it was 2.5 million years ago. Star maps are not images of a single \"now\" — they are a montage of *delivered pasts*. The night sky is the cycle's canonical artifact."
       }
      }
     ]
    },
     ...
     "blocks": [
      {
       ...
       "everyone": {
        "kind": "list",
        "text": "- **A flood going in, a trickle coming out.** Millions to billions of bits of information arrive at the eye every second, and only about 10–50 bits per second get as far as conscious attention and choice (Zheng & Meister 2023).\n- Implication: the lived present is an *extremely compressed summary* of the photonic stream. This is not a defect of the theory — it is a prediction of it. The \"now\" is the highest-value compression of the arriving information, and perceived rate should track the *processed* small stream, not the raw large one. This gives the theory a concrete, testable handle (§8).",
        "level": null,
        "number": null,
        "name": "- **A flood going in, a trickle coming out.** Millions to billions of bits of information arrive at the eye every second, and only about 10–50 bits per second get as far as conscious attention and choice (Zheng & Meister 2023).\n- Implication: the lived present is an *extremely compressed summary* of the photonic stream. This is not a defect of the theory — it is a prediction of it. The \"now\" is the highest-value compression of the arriving information, and perceived rate should track the *processed* small stream, not the raw large one. This gives the theory a concrete, testable handle (§8)."
       }
      }
     ]
    }
     ...
     "blocks": [
      {
       ...
       "everyone": {
        "kind": "list",
        "text": "- **H1a (More to look at, longer it feels).** If more is going on during a stretch of time, you judge that stretch to have been longer — while you are still living through it. This is a well-established effect, and H1 doesn't replace it: it explains it.\n- **H1b (Bottleneck flattening):** When processed throughput is clamped (monotony, dark adaptation, meditative stillness, sedation), felt duration compresses toward a baseline drift.\n- **H1c (Novelty spikes):** Sudden information spikes (surprises, onsets) inflate local felt duration (the oddball effect — an established finding).\n- **H1d (Latency pooling):** Simultaneity judgments depend on coding/arrival windows, so physically asynchronous arrivals within ~20–30 ms are felt as co-present.",
        "level": null,
        "number": null,
        "name": "- **H1a (More to look at, longer it feels).** If more is going on during a stretch of time, you judge that stretch to have been longer — while you are still living through it. This is a well-established effect, and H1 doesn't replace it: it explains it.\n- **H1b (Bottleneck flattening):** When processed throughput is clamped (monotony, dark adaptation, meditative stillness, sedation), felt duration compresses toward a baseline drift.\n- **H1c (Novelty spikes):** Sudden information spikes (surprises, onsets) inflate local felt duration (the oddball effect — an established finding).\n- **H1d (Latency pooling):** Simultaneity judgments depend on coding/arrival windows, so physically asynchronous arrivals within ~20–30 ms are felt as co-present."
       }
      }
     ]
    },
     ...
     "blocks": [
      {
       ...
       "everyone": {
        "kind": "paragraph",
        "text": "One idea — how much information is coming in — pulls four separate findings about time into the same family: the filled-duration illusion (a); the oddball effect, where a surprise stretches the moment it lands in (b); the attentional-gate results of Zakay and Block (c); and the everyday complaint that time \"speeds up\" when life gets boring (d) — in a dull, unchanging stretch, less information gets in, and time feels thinner both as it happens and afterwards. H1 wasn't invented to fit these results; it predicts them. What the theory adds is the *reason they belong together at all*: they are all signs of a single thing — felt time is built out of the information arriving.",
        "level": null,
        "number": null,
        "name": "One idea — how much information is coming in — pulls four separate findings about time into the same family: the filled-duration illusion (a); the oddball effect, where a surprise stretches the moment it lands in (b); the attentional-gate results of Zakay and Block (c); and the everyday complaint that time \"speeds up\" when life gets boring (d) — in a dull, unchanging stretch, less information gets in, and time feels thinner both as it happens and afterwards. H1 wasn't invented to fit these results; it predicts them. What the theory adds is the *reason they belong together at all*: they are all signs of a single thing — felt time is built out of the information arriving."
       }
      }
     ]
    }
  ...
  },
  {
   ...
   "blocks": [
    ...
    },
    {
     ...
     "everyone": {
      "kind": "paragraph",
      "text": "Of the theory's three claims, one is settled, one is live, one is a bet — and the reader is told which is which. That seeing is light-delivered information is already confirmed by physiology a hundred times over. That felt time tracks information throughput is the part experiments can test today (§8's list is where the theory sticks its neck out). That reality's manifest aspect *is* that delivered information is the philosophical component: no experiment can settle it directly, and rather than smuggle it in, the theory grades it openly (the Popper-grading of §5.5). One claim is history, one is science, one is metaphysics.",
      "level": null,
      "number": null,
      "name": "Of the theory's three claims, one is settled, one is live, one is a bet — and the reader is told which is which. That seeing is light-delivered information is already confirmed by physiology a hundred times over. That felt time tracks information throughput is the part experiments can test today (§8's list is where the theory sticks its neck out). That reality's manifest aspect *is* that delivered information is the philosophical component: no experiment can settle it directly, and rather than smuggle it in, the theory grades it openly (the Popper-grading of §5.5). One claim is history, one is science, one is metaphysics."
     }
    }
   ],
   "subsections": []
     ...
     "blocks": [
      {
       ...
       "everyone": {
        "kind": "paragraph",
        "text": "If the cycle is right, the world you see isn't a stage where stuff happens — it's information being processed. Light is the courier; what you see is its message after decoding. And there are only two layers: the physical side (light emitted, scattered, absorbed — whatever the cycle's equations describe) and the experienced side (the decoded result you actually meet). No third layer, no hidden substance underneath. That is why the theory sits between two familiar positions: it isn't idealism, because the world really is out there and not mind-made; and it isn't plain physicalism either, because what we meet is never raw stuff — it is always information.",
        "level": null,
        "number": null,
        "name": "If the cycle is right, the world you see isn't a stage where stuff happens — it's information being processed. Light is the courier; what you see is its message after decoding. And there are only two layers: the physical side (light emitted, scattered, absorbed — whatever the cycle's equations describe) and the experienced side (the decoded result you actually meet). No third layer, no hidden substance underneath. That is why the theory sits between two familiar positions: it isn't idealism, because the world really is out there and not mind-made; and it isn't plain physicalism either, because what we meet is never raw stuff — it is always information."
       }
      }
     ]
    },
     ...
     "blocks": [
      {
       ...
       "everyone": {
        "kind": "paragraph",
        "text": "Light is the past arriving. Every photon that reaches you left at a particular moment, carrying what was happening then; look at Andromeda and you are receiving something that set off billions of years ago. So the past is less like a memory and more like a delivery — part of it is still in transit, and it keeps turning up. This also settles an old argument. On one side, the geometry of space–time says the past is still out there (the light cone exists). On the other, we only ever seem to meet the present. Both are right: the cone is real, and the part of it you can actually read moves as you do. The past is real; the present is the slice of it that has reached you.",
        "level": null,
        "number": null,
        "name": "Light is the past arriving. Every photon that reaches you left at a particular moment, carrying what was happening then; look at Andromeda and you are receiving something that set off billions of years ago. So the past is less like a memory and more like a delivery — part of it is still in transit, and it keeps turning up. This also settles an old argument. On one side, the geometry of space–time says the past is still out there (the light cone exists). On the other, we only ever seem to meet the present. Both are right: the cone is real, and the part of it you can actually read moves as you do. The past is real; the present is the slice of it that has reached you."
       }
      }
     ]
    },
     ...
     "blocks": [
      {
       ...
       "everyone": {
        "kind": "paragraph",
        "text": "Physics has already made the world observer-relative twice — but not in any hand-wavy, \"reality is all in your head\" sense. Relativity says *when* an event happens depends on who is watching; quantum mechanics (in Rovelli's relational formulation) says even a particle's state is defined relative to the system it interacts with. Both are facts about how information is exchanged, not about minds being special. The cycle simply extends the same lesson to perception: \"observer-dependence\" means the world presents itself *through channels*, and a channel exists wherever light interacts with something — brain or no brain.",
        "level": null,
        "number": null,
        "name": "Physics has already made the world observer-relative twice — but not in any hand-wavy, \"reality is all in your head\" sense. Relativity says *when* an event happens depends on who is watching; quantum mechanics (in Rovelli's relational formulation) says even a particle's state is defined relative to the system it interacts with. Both are facts about how information is exchanged, not about minds being special. The cycle simply extends the same lesson to perception: \"observer-dependence\" means the world presents itself *through channels*, and a channel exists wherever light interacts with something — brain or no brain."
       }
      }
     ]
    },
     ...
     "blocks": [
      {
       ...
       "everyone": {
        "kind": "paragraph",
        "text": "Wheeler gave the idea a name — \"it from bit\": everything that exists gets its structure and its meaning out of yes-or-no answers. The cycle turns that into something you can point at. The bits arrive as light. A bit is not an abstraction here; it is a physical event — a photon's energy, its timing, its direction — and everything you see is a decoded pile of such arrivals. Wheeler said the universe runs on information; the cycle says which channel (light), which code (the photon stream), and where the decoding happens (the stages of the cycle).",
        "level": null,
        "number": null,
        "name": "Wheeler gave the idea a name — \"it from bit\": everything that exists gets its structure and its meaning out of yes-or-no answers. The cycle turns that into something you can point at. The bits arrive as light. A bit is not an abstraction here; it is a physical event — a photon's energy, its timing, its direction — and everything you see is a decoded pile of such arrivals. Wheeler said the universe runs on information; the cycle says which channel (light), which code (the photon stream), and where the decoding happens (the stages of the cycle)."
       }
      }
     ]
    },
     ...
     "blocks": [
      {
       ...
       "everyone": {
        "kind": "list",
        "text": "- The theory does **not** solve the hard problem. It simply assumes experience happens and explains the *shape* of its time — why felt duration stretches, compresses, and saturates as information flows. Why that compression is *felt* at all — why there is someone home to feel it — is deliberately left open.\n- The theory does not decide presentism vs. eternalism wholesale; it is compatible with both, and that compatibility is itself informative.\n- The theory is not a theory of everything; it is a theory of the *observational relationship* between world and perceiver. [[The Theory]] and [[The Unified Theory of Everyone]] pursue the wider unification; the cycle can be read as their localized, empirically anchored branch.",
        "level": null,
        "number": null,
        "name": "- The theory does **not** solve the hard problem. It simply assumes experience happens and explains the *shape* of its time — why felt duration stretches, compresses, and saturates as information flows. Why that compression is *felt* at all — why there is someone home to feel it — is deliberately left open.\n- The theory does not decide presentism vs. eternalism wholesale; it is compatible with both, and that compatibility is itself informative.\n- The theory is not a theory of everything; it is a theory of the *observational relationship* between world and perceiver. [[The Theory]] and [[The Unified Theory of Everyone]] pursue the wider unification; the cycle can be read as their localized, empirically anchored branch."
       }
      }
     ]
    }
   ...
   "blocks": [
    {
     ...
     "everyone": {
      "kind": "list",
      "text": "1. **Consciousness's presence.** The hard problem is bracketed, honestly: the cycle explains the *shape* of conscious time but not why running the cycle feels like anything at all.\n1. **Ontological undecidability.** No experiment could force a verdict on claim (2); its defense is that it holds together better than its rivals. Readers who demand an empirical tie-breaker will find the ontology underdetermined — but that is true of every ontology, physicalism included.\n1. **Model imprecision.** The link from information flow to felt time is currently unspecified beyond \"rises, then saturates.\" Measurement of the sensory bottleneck (Zheng & Meister 2023) suggests information flow should be measured after attention has filtered it, but the exact operational definition requires experimental iteration.\n1. **Generalization burden.** The extension beyond vision (O1) is sketched, not developed. A full theory needs a formal \"sound cycle\" for hearing and a unified multichannel information-integration account.\n1. **Relativistic position of the \"constructed now.\"** Your now is built by your brain, so it is a local artifact of your body rather than a cosmic slice. The cycle describes how one observer's present is constructed, but not yet how different observers' presents line up across frames — an open coordination problem, not a cosmological one.\n1. **The creative/physical boundary.** The theory deliberately speaks in two registers — poetry and physics — and they must stay labeled. \"Time stands still\" works as a flagged image and fails the moment it is read as literal physics; crossing that line unnoticed is the theory's characteristic failure mode, and its author's own wider writing warns against exactly this (the operational-boundary problem).",
      "level": null,
      "number": null,
      "name": "1. **Consciousness's presence.** The hard problem is bracketed, honestly: the cycle explains the *shape* of conscious time but not why running the cycle feels like anything at all.\n1. **Ontological undecidability.** No experiment could force a verdict on claim (2); its defense is that it holds together better than its rivals. Readers who demand an empirical tie-breaker will find the ontology underdetermined — but that is true of every ontology, physicalism included.\n1. **Model imprecision.** The link from information flow to felt time is currently unspecified beyond \"rises, then saturates.\" Measurement of the sensory bottleneck (Zheng & Meister 2023) suggests information flow should be measured after attention has filtered it, but the exact operational definition requires experimental iteration.\n1. **Generalization burden.** The extension beyond vision (O1) is sketched, not developed. A full theory needs a formal \"sound cycle\" for hearing and a unified multichannel information-integration account.\n1. **Relativistic position of the \"constructed now.\"** Your now is built by your brain, so it is a local artifact of your body rather than a cosmic slice. The cycle describes how one observer's present is constructed, but not yet how different observers' presents line up across frames — an open coordination problem, not a cosmological one.\n1. **The creative/physical boundary.** The theory deliberately speaks in two registers — poetry and physics — and they must stay labeled. \"Time stands still\" works as a flagged image and fails the moment it is read as literal physics; crossing that line unnoticed is the theory's characteristic failure mode, and its author's own wider writing warns against exactly this (the operational-boundary problem)."
     }
    }
   ],
   "subsections": []
   ...
   "blocks": [
    {
     ...
     "everyone": {
      "kind": "paragraph",
      "text": "The whole theory in one breath: we know the world because the world sends messengers; the world we actually meet *is* those messages, already decoded; and time feels the way it does because of how fast they keep arriving and get turned into experience. Messenger, message, tempo.",
      "level": null,
      "number": null,
      "name": "The whole theory in one breath: we know the world because the world sends messengers; the world we actually meet *is* those messages, already decoded; and time feels the way it does because of how fast they keep arriving and get turned into experience. Messenger, message, tempo."
     }
    },
    {
     "original": {
